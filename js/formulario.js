            ...
            switch (input.target.id) {
                case "nombre":
                    ...
                    if (pf.valor.length < 2 || pf.valor.length > 6) {
                        ...
                        console.log("Error, nombre corto o muy largo.");

                        //Seleccionamos el div que acabamos de crear en el metodo focus.
                ...
                case "contrasena":
                    ...
                    //Usamos el metodo test, con el que validamos que el valor del input cumpla
                    //con la expresionRegular.
                    if (!pf.expresionRegular.test(pf.valor)) {

                        console.log("Error con contrasena.");
